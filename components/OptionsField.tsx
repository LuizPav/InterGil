    ...
    <View className="flex-1 flex-row flex-wrap">
      ...
      >
        <Image
          ...
          resizeMode="contain"
        />
        <Text className="text-3xl pb-8 pt-0">Modalidades</Text>
      </Pressable>
      ...
      >
        <Image
          ...
          resizeMode="contain"
        />
        <Text className="text-3xl pb-8 pt-0">Confrontos</Text>
      </Pressable>
      ...
      >
        <Image
          ...
          resizeMode="contain"
        />
        <Text className="text-3xl pb-8 pt-0">Placar</Text>
      </Pressable>
      ...
      >
        <Image
          ...
          resizeMode="contain"
        />
        <Text className="text-3xl pb-8 pt-0">Casas</Text>
      </Pressable>
    </View>
  );
}
